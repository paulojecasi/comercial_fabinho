        ...
        <div class="col-lg-12 table-mov-caixa-pro">
            <div>
                <section id="table-scroll-rel">
                    ...
                    $this->table->add_row($desTot, "", "", "", "", "","",$valortotNotaToti, $valortotToti,$vlFatLucToti, "");
                    $this->table->set_template(array(
                                    'table_open' => '<table class="table table-striped table-rels">'));

                    echo $this->table->generate(); 
                    $descDFAT =  '<h5 class="text-center" id="vl-fat-pos-r"> Total DFAT:  R$ <b id="vl-fat-pos-rel">'.$vlFatLucTot.'</b> </h5>';
