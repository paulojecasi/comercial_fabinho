<div class = "row">
    ...
    <div class = "text-center tipo-de-pagamento-escolha tipo-de-pagamento-credito">
        <h2> Pagamento no Cartão de Crédito </h2>
    </div>
    ...
    <div class = "col-lg-12 col-sm-12 titulo-tela-tipopag5">
        ...
        <div class="col-lg-12 col-sm-12 card-debit text-center">
            <div class="form-group">
                ...
                <a href="<?php echo base_url('venda/finalizar_venda/3/').$idcaixa ?>"> 
