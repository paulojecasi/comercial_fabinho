if ($('#form-fechamento-caix').val() ==10) {
  ...
  jQuery(document).ready(function(){
    jQuery('input').on('keyup',function(){
      ...
      var pix_transferencia
                      = (jQuery('#pix_transferencia').val() == '' ? 0 : jQuery('#pix_transferencia').val());
      ...
      var pix_transferencia_c
                      = (jQuery('#pix_transferencia_c').val() == '' ? 0 : jQuery('#pix_transferencia_c').val());
      ...
      var pix_transferencia_fs      
                            = (parseFloat(pix_transferencia_c) - parseFloat(pix_transferencia)); 
      ...
      var pix_transferencia_fs = parseFloat(pix_transferencia_fs).toFixed(2);
      ...
      jQuery('#pix_transferencia_fs').val(pix_transferencia_fs);
      ...
      if (pix_transferencia_fs < 0){
        $('#pix_transferencia_fs').css("color",corNeg);
      }else{
        $('#pix_transferencia_fs').css("color",corPos); 
      }
