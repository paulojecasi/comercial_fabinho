if ($('#form-alt-produto-tem').val() ==1) {
    ...
    jQuery(document).ready(function(){
      jQuery('input').on('keyup',function(){
        ...
        var quantidadeitens_orig = (jQuery('#quantidadeitens_orig').val() == '' ? 0 : jQuery('#quantidadeitens_orig').val());
        ...
        var qt_saida =  (parseFloat(quantidadeitens) 
                        - parseFloat(quantidadeitens_orig) 
                        + parseFloat(qt_da_venda));
